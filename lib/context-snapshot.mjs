...
//
// Usage:
//   node lib/context-snapshot.mjs --build <dir>       → JSON to stdout
//   node lib/context-snapshot.mjs --write <dir>       → write to zeus/memory/
//   node lib/context-snapshot.mjs --check <jsonpath>  → FRESH | STALE | INVALID
//   node lib/context-snapshot.mjs --validate <path>   → VALID | INVALID
//   node lib/context-snapshot.mjs --help
