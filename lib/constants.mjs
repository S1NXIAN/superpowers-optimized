...
export const FILE_COPIES = [
  ...
  { repoRel: 'agents/sub/hacker.md', configRel: 'agents/hacker.md', executable: false },
  { repoRel: 'agents/sub/architect.md', configRel: 'agents/architect.md', executable: false },
  { repoRel: 'agents/sub/designer.md', configRel: 'agents/designer.md', executable: false },
  { repoRel: 'agents/sub/qa-pro.md', configRel: 'agents/qa-pro.md', executable: false },
  { repoRel: 'agents/sub/cleaner.md', configRel: 'agents/cleaner.md', executable: false },
  { repoRel: 'agents/sub/spec-reviewer.md', configRel: 'agents/spec-reviewer.md', executable: false },
  { repoRel: 'agents/sub/code-quality.md', configRel: 'agents/code-quality.md', executable: false },
];
